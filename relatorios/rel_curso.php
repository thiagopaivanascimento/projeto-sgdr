...
$pdf->SetName("Relatório de Cursos","SGDR - Sistema de Gerenciamento Didático Remoto"); // Cabeçalho do Relatório
...
$pdf->Cell(50,6,'Curso','B',0,'C');
$pdf->Cell(30,6,'Semestre','B',0,'C');
$pdf->Cell(30,6,'Carga Horária','B',1,'C');
...
$pdf->Cell(30,6,pg_fetch_result($res,$i,'semestre'),1,0,'C');
$pdf->Cell(30,6,pg_fetch_result($res,$i,'carga_horaria'),1,1,'C');
}
