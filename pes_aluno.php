   ...
   <br>
	<div align="center">
     ...
     <table border="0" align="center">
      ...
      <td align="left"><input type="text" name="txtAluno" value="<?php $txtAluno; ?>" size="30"></td>
	 ...
	 <?php
	  ...
	  $txtAluno = isset($_POST["txtAluno"]);		
      $sql = "SELECT * FROM alunos WHERE aluno like '%$txtAluno%' ORDER BY aluno";
